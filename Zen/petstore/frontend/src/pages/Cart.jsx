...
export default function Cart() {
  const { cartItems, cartTotal, updateQuantity, removeFromCart, loading } =
    useCart();
    ...
    return (
      <div style={{ textAlign: "center", padding: "100px 20px" }}>
        <ShoppingBag
          size={80}
          color="#F97316"
          style={{ margin: "0 auto 20px", display: "block", opacity: 0.4 }}
        />
    ...
    >
      ...
      <div className="cart-layout">
              ...
              return (
                ...
                >
                  <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                    ...
                    <div>
                      <p style={{ fontWeight: 600, color: "#991B1B", fontSize: 14, margin: 0 }}>
                        Product no longer available
                      </p>
                      <p style={{ fontSize: 12, color: "#EF4444", margin: 0 }}>
                        This item has been removed by the seller
                      </p>
                    </div>
                  </div>
                  <button
                ...
                <div style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
                  ...
                  <div
                    style={{
                      ...
                      backgroundImage: resolveImage(item.image)
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <p style={{ color: "#9CA3AF", fontSize: 11, marginTop: 2, marginBottom: 0 }}>
                      per unit
                    </p>
                  </div>
        ...
        <div className="cart-summary-wrapper">
          ...
          >
            <h3 style={{ fontWeight: 700, fontSize: 17, marginBottom: 18 }}>
              Order Summary
            </h3>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 11, marginBottom: 16 }}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", fontSize: 14 }}>
                ...
                <span style={{ fontWeight: 600 }}>
                  <Rs />{shipping}{" "}
                  <span style={{ fontSize: 11, color: "#9CA3AF", fontWeight: 400 }}>(est.)</span>
                </span>
              </div>
            ...
            >
              ...
              <span style={{ color: "#10B981", fontWeight: 700 }}>FREE shipping!</span>
              <br />
              📦 Other states: <strong><Rs />99</strong> flat rate.
              <br />
            ...
            <Link
              ...
              style={{
                ...
                gap: 8, padding: "13px", boxSizing: "border-box",
              }}
            >
