...
const buildItemsHTML = (items) =>
  items.map((item) => `
    <tr>
      <td style="padding:10px 12px;border-bottom:1px solid #f0e6d3;font-size:14px;color:#333;">
        ${item.name}
      </td>
      <td style="padding:10px 12px;border-bottom:1px solid #f0e6d3;text-align:center;font-size:14px;color:#333;">
        ${item.quantity}
      </td>
