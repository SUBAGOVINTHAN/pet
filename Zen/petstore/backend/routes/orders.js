...
router.post('/', authenticate, async (req, res) => {
  ...
  try {
    ...
    const {
      shipping,
      payment_method    = 'razorpay',  // ← changed default
      coupon_code,
      notes,
      payment_id        = null,         // ← NEW: from Razorpay
      razorpay_order_id = null,         // ← NEW: from Razorpay (optional to store)
    } = req.body;
    ...
    // ── TN = FREE shipping, all other states = ₹99 ───────────────────────
    ...
    const [orderResult] = await conn.query(
      ...
      [
        ...
        payment_id ? 'paid' : 'pending',  // payment_status
